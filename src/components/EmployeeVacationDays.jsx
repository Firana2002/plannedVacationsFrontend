...
const EmployeeVacationDaysTable = () => {
    ...
    const filteredVacationDays = vacationDays.filter(day => {
        const fullName = `${day.employee.firstName} ${day.employee.lastName}`.toLowerCase();
        return fullName.includes(searchTerm.toLowerCase()) || 
               day.vacationType.name.toLowerCase().includes(searchTerm.toLowerCase());
    });
    ...
    return (
        <div className="employees-container">
            <div className="page-header">
                <h2 className="text-xl font-bold">Дни отпуска сотрудников</h2>
...
export default EmployeeVacationDaysTable;